...
ridge_med_1 <- median((ridge_pred_1 - y_data1))
...
ridge_med_2 <- median((ridge_pred_2 - y_data2))
#Extract the coefficients of each variable in the model
ridge_data2$beta
...
ridge_med_3 <- median((ridge_pred_3 - y_data3))
#Extract the coefficients of each variable in the model
ridge_data1$beta
```
...
lasso_med_1 <- median((lasso_pred_1 - ly_data1))
#Extract the coefficients of each variable in the model
lasso_data1$beta
...
lass0_med_2 <- median((lasso_pred_2 - ly_data2))
#Extract the coefficients of each variable in the model
lasso_data2$beta
...
lasso_med_3 <- median((lasso_pred_3 - ly_data3))
#Extract the coefficients of each variable in the model
lasso_data3$beta
```
