...
normy(training_data$AlbumBestChartPosition)
normy(training_data$AlbumWeeksNumberOne)
normy(training_data$AlbumPopularity)
normy(training_data$ArtistPopularity)
#Gets the 20% percentile for example
as.numeric(normy(training_data$ArtistNumFollowers)[3])

training_data <- training_data %>%
  mutate(album_weeks_n = if_else())
