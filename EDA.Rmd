...
ap <- normy(training_data$ArtistPopularity)
...
training_data <- training_data %>%
  mutate(album_weeks_n = if_else(AlbumBestChartPosition == 0, 1,
                         ...
                         if_else(AlbumBestChartPosition > abcp_normy[5] && AlbumBestChartPosition < abcp_normy[6], 7,
                         if_else(AlbumBestChartPosition > abcp_normy[6] && AlbumBestChartPosition < abcp_normy[7], 6,
                         if_else(AlbumBestChartPosition > abcp_normy[7] && AlbumBestChartPosition < abcp_normy[8], 5,
                         if_else(AlbumBestChartPosition > abcp_normy[8] && AlbumBestChartPosition < abcp_normy[9], 4,
                         if_else(AlbumBestChartPosition > abcp_normy[9] && AlbumBestChartPosition < abcp_normy[10], 3,
                         if_else(AlbumBestChartPosition > abcp_normy[10] && AlbumBestChartPosition < abcp_normy[11], 2, 0 )))))))))))

#This is obviously wrong but not sure why...         
training_data %>% 
